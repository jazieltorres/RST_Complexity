...
3D_TestTernarySimple: main_MultipleTests.o MultiDimArray.o Sequences.o
	$(CXX) $(CXXFLAGS) -o 3D_TestTernarySimple main_MultipleTests.o MultiDimArray.o Sequences.o -lntl -lblitz -lgmp
