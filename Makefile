...
multiTest_ternarySimple2D: main_MultipleTests.o MultiDimArray.o Sequences.o
	$(CXX) $(CXXFLAGS) -o multiTest_ternarySimple2D main_MultipleTests.o MultiDimArray.o Sequences.o -lntl -lblitz -lgmp
