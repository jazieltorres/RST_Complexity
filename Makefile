...
main_RandCompositionNEW: RandomComposition.o MultiDimArray_GF2.o Sequences.o
	$(CXX) $(CXXFLAGS) -o main_RandCompositionNEW RandomComposition.o MultiDimArray_GF2.o Sequences.o -lntl -lblitz -lgmp
