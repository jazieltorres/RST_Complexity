...
multiTest_binarySimple: main_MultipleTests.o MultiDimArray.o Sequences.o
	$(CXX) $(CXXFLAGS) -o multiTest_binarySimple main_MultipleTests.o MultiDimArray.o Sequences.o -lntl -lblitz -lgmp
