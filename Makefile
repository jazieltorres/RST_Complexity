...
Rational_simple: main_RationalShift.o MultiDimArray.o Sequences.o
	$(CXX) $(CXXFLAGS) -o Rational_simple main_RationalShift.o MultiDimArray.o Sequences.o -lntl -lblitz -lgmp
